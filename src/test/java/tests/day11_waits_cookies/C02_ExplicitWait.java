...
public class C02_ExplicitWait {
    ...
    public void implicitlyWaitTesti() throws InterruptedException {
        ...
        WebElement itsBack = driver.findElement(By.xpath("//*[.=\"It's back!\"]"));
    ...
    public void explicitlyWaitTesti(){
        ...
        WebElement itsGoneYaziElementi = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("message")));
