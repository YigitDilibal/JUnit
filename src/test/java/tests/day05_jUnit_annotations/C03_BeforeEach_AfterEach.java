...
public class C03_BeforeEach_AfterEach {
    ...
    /*
        6- driver olusturmak icin kullandigimiz setup() ve
           driveri kapatmak icin kullandigimiz teardown() method'lari
           bagimsiz calismasi gereken method'lar degil
           @Test method'undan once ve sonra calismasi gereken ozel methodlardir

         7- Eger setup() her @Test method'undan once calismini isterseniz
            @BeforeEach kullanabilirsiniz
            Ayni sekilde teardown() her@test methodundan sonra otomatik
            olarak calismasini isterseniz @AfterEach kullanabilirsiniz.
     */
    ...
    // @Disabled gecici olarak bu method'un kullanilmamasini istedigimizde kullanilir.
    @Test
    public void youtubeTesti() throws InterruptedException {

        // 2- youtube ana sayfaya gidin
